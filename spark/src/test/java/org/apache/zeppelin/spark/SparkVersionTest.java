...
public class SparkVersionTest {
  ...
  public void sqlParseTest() throws org.apache.hadoop.hive.ql.parse.ParseException, IOException, SemanticException {
    ...
    System.out.println(parseDriver.parse("select a.task_id,mode,allot,a.open_state,a.manager_name,a.state,category1id,category2id,category_id,a.amount,hosted_amount,task_source,d.close_ymd,refused,hosted,hosted_date from ods_mk_task a\n" +
